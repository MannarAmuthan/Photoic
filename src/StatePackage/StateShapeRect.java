...
public class StateShapeRect extends State {
    Layer l;
    ...
    public StateShapeRect(WorkPlace place) {
        ...
        stroke.setOnAction((ActionEvent event) -> {
            if(drawed){
                ...
                Imgproc.rectangle(l.backstageMat, lastPoint, current, new Scalar(blue,green,red,255),Universal.strokeWidth);
                drawed=false;
                place.update();
            }
        });
        fill.setOnAction((ActionEvent event) -> {
            if(drawed){
                ...
                int green=(int)(Universal.currentColor.getGreen()*255);
                int red=(int)(Universal.currentColor.getRed()*255);
                Imgproc.rectangle(l.backstageMat, lastPoint, current, new Scalar(blue,green,red,255),-1);
                drawed=false;
                place.update();
            }
        });
    ...
    public void onMouseDragged(MouseEvent event, Layer l) {
        ...
        System.out.println("drawn.. i "+current);
