...
public class StateMove extends State{
    ...
    super(place);
    moveAmountSide=Universal.canvasWidth/20;
    moveAmountStraight=Universal.canvasHeight/20;
    if(moveAmountSide<5){moveAmountSide=5;}
    if(moveAmountStraight<5){moveAmountStraight=5;}
    }
    @Override
